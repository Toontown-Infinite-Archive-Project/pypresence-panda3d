...
class TestPresenceUpdate:
    ...
    def test_update_basic(self, mock_read_output, client_id):
        ...
        mock_read_output.return_value = mock_output
...
class TestPresenceConnect:
    ...
    def test_connect(self, mock_handshake, client_id, mock_ipc_path):
        ...
        presence = Presence(client_id)
        # Mock the handshake to be a simple callable
...
@pytest.mark.skip(reason="async tests skipped after asyncio removal")
class TestAioPresence:
    """Test async Presence class (skipped)"""
    ...
    def test_aio_presence_update(self):
        pass
